  ...
  themeConfig: {
    ...
    sidebar: {
      "/structure/": [
        ...
        {
          text: "Taro",
          children: ["/structure/taro/README.md"],
        },
        {
          text: "webpack",
          children: [
            ...
            },
            {
              text: "高级优化",
              children: [
                "/structure/webpack/senior/README.md",
                "/structure/webpack/senior/enhanceExperience.md",
                "/structure/webpack/senior/liftingSpeed.md",
                "/structure/webpack/senior/reduceVolume.md",
                "/structure/webpack/senior/optimizePerformance.md",
                "/structure/webpack/senior/summary.md",
              ],
            },
            {
              text: "项目配置",
              children: [
                "/structure/webpack/project/README.md",
                "/structure/webpack/project/react-cli.md",
                "/structure/webpack/project/vue-cli.md",
                "/structure/webpack/project/summary.md",
              ],
            },
            {
              text: "原理分析",
              children: [
                "/structure/webpack/origin/README.md",
                "/structure/webpack/origin/loader.md",
                "/structure/webpack/origin/plugin.md",
                "/structure/webpack/origin/summary.md",
              ],
            },
          ],
        },
