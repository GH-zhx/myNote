...
(function () {
    ...
    var doneBattleMsg = ""
    var 捕捉ok = false
    var catchCount = 0 // 修改为捕捉个数，直到捕捉到指定数量精灵为止
    ...
    if (topWindow == window) {
        ...
        button9.onclick = async function () {
            ...
            while (1) {
                if (isAllowCapture && catchC.value > 0) {
                    await catchPet()
                }else{
                    break
                }
        ...
        var stopBuZhuo = document.createElement("button");
        stopBuZhuo.innerHTML = "停止捕捉";
        stopBuZhuo.style.margin = "4px";
        stopBuZhuo.style.width = "75px";
        stopBuZhuo.style.height = "30px";
        stopBuZhuo.onclick = async function () {
          catchCount = 0
          isAllowCapture = false
        };
        div.appendChild(stopBuZhuo);
        ...
        // 用于清楚log信息
        var actionClearBtn = document.createElement("button");
        actionClearBtn.innerHTML = "清除log";
        actionClearBtn.style.margin = "4px";
        actionClearBtn.style.width = "75px";
        actionClearBtn.style.height = "30px";
        // 在点击按钮时输出日志到文本框中
        actionClearBtn.onclick = async function () {
            logTextArea.value = ''
        };
        div.appendChild(actionClearBtn);
        ...
        logTextArea.style.height = "350px";
